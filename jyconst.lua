...
function SetGlobalConst()
	...
	CC.Base_S["特殊"]={30,0,2};
	CC.Base_S["单通"]={32,0,2};
	CC.Base_S["天书数量"]={34,0,2};

	for i=1,CC.TeamNum do
		CC.Base_S["队伍" .. i]={36+2*(i-1),0,2};
	end

	for i=1,CC.MyThingNum do
		CC.Base_S["物品" .. i]={66+4*(i-1),0,2};
		CC.Base_S["物品数量" .. i]={66+4*(i-1)+2,0,2};
	end
	...
	CC.Exp={   60000, 60000, 60000 ,60000 , 60000 ,
               60000, 60000, 60000 ,60000 , 60000 ,
               60000, 60000, 60000 ,60000 , 60000 ,
               60000, 60000, 60000 ,60000 , 60000 ,
               60000, 60000, 60000 ,60000 , 60000 ,
	           60000, 60000, 60000 ,60000 , 60000 , [0] = 0 };
...
{609, 4250} --赵敏离队事件
	...
	"Ｎ",
	"Ｒ特色指令：虚弱",
	"Ｗ用毒药麻痹一名敌人的神经，使其在30时序内造成的伤害杀气减半"
	}
	TFJS[72] = {"Ｌ天龙掌门",
	"Ｗ无视兵器值需求装备『闯王军刀』",
	...
	TFJS[29] = {"Ｌ万里独行",
	"Ｗ单独行动时等级提升1级，无视经过敌人身边的移动限制，且移动格数翻倍"
	}
	TFJS[31] = {"Ｌ江南四友",
	"Ｗ "
	}
	...
	"Ｎ",
	"Ｚ无招胜有招",
	"Ｗ暴怒时，使用独孤九剑攻击触发，追加2000点气攻，被击中的敌方将静止10时序"
	}
	TFJS[73] = {"Ｌ琴铮盈盈",
	"Ｗ使用持瑶琴，几率发动“七弦无形剑气”，对敌方全体造成50×血量倍数的伤害",
	"Ｎ",
	"Ｌ日月圣姑",
	"Ｗ每时序回复自身5点中毒"
	}
	...
	--阎基
	GRTS[4] = "虚弱"
	GRTSSAY[4] = "效果：用毒药麻痹一名敌人的神经*      使其在30时序内造成的伤害杀气减半*消耗：体力10点"
