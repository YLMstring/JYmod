...
function My_ChuangSong_List()
	...
	for i = 0, JY.SceneNum-1 do
		...
		or i == 117 or i == 104 or i == 119 or i == 102 or i == 122 or i == 123 then
...
function My_ChuangSong_Ex()     
	...
	elseif r == 2 then
		...
		if sid ~= nil then			
			--标注几个不显示的：闯王宝藏1 3 明教地道，高昌迷宫+沙漠废墟3组 少林寺 思过崖 梅庄地牢 大功坊地窖 无量山洞 鹿鼎山1 3 鹊桥
			...
			or sid == 108 or sid == 109 or sid == 110 or sid == 111 or sid == 113 or sid == 114 or sid == 104 or JY.Scene[sid]["进入条件"] == 1 then
